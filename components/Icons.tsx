...
export const LoadingSpinner = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="animate-spin" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0l3.181 3.183a8.25 8.25 0 0011.667 0l3.181-3.183m-4.991-2.696h4.992c.11 0 .217.025.324.074M7.501 14.383a8.25 8.25 0 0111.667 0l3.181 3.183m0 0c.049.049.097.1.146.152v4.242m-4.992-4.242l3.183 3.183a8.25 8.25 0 000 11.667l-3.183 3.183m0-11.667a8.25 8.25 0 00-11.667 0l-3.183 3.183" />
    </svg>
);
